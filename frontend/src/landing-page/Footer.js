    ...
    <footer className='' style={{backgroundColor:"rgba(248, 246, 244, 1)"}}>
      <div className='container border-top text-muted'>
        ...
        <div className='footer text-muted fs-6 mt-5 '>
          ...
          <div className="text-muted footerEnd mb-3 custom">
            <ul>
              <li><a href="" className="text-muted custom">NSE</a></li>
              <li><a href="" className="text-muted custom">BSE</a></li>
              <li><a href="" className="text-muted custom">MCX</a></li>
              <li><a href="" className="text-muted custom">Terms &amp; conditions</a></li>
              <li><a href="" className="text-muted custom">Policies &amp; procedures</a></li>
              <li><a href="" className="text-muted custom">Privacy policy</a> </li>
              <li><a href="" className="text-muted custom">Disclosure</a></li>
              <li><a href="" className="text-muted custom">For investor's attention</a></li>
              <li><a href="" className="text-muted custom">Investor charter</a></li>
            </ul>
          </div>
        </div>
      </div>
